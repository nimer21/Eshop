...
const PricingCard = ({name='', price= 0, currency='$', frequency = 'month', features=[], featured=false}) => {
  return (
    <div className='h-full flex justify-center items-center px-6 py-12'>
        <div className={`bg-white border-indigo-600 rounded-md shadow-xl cursor-pointer
        relative ${
            ...
            {
                featured ? (
                    <span className='bg-indigo-600 text-white px-6 py-1 rounded-full
            ...
            <div className='p-12 hero-bg-color'>
                ...
                {/* CAT call-to-action  */}                
                <button className={`mt-12 w-full py-4 px-8 rounded-lg text-lg whitespace-nowrap
